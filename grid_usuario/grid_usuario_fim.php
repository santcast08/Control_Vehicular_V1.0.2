...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_usuario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_usuario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_usuario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_usuario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_usuario']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_usuario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_usuario']['embutida_filho'] as $ind => $sc_init)
          {
