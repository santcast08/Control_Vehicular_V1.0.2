...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["usuario_idusuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["usuario_idusuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["usuario_idusuario"] : "Conductor";
   ...
   $tab_ger_campos['vehiculo_km_inicial'] = "on";
   $tab_def_campos['vehiculo_km_inicial'] = "Vehiculo_Km_Inicial";
   $tab_converte["Vehiculo_Km_Inicial"]   = "vehiculo_km_inicial";
   $tab_labels["vehiculo_km_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_km_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_vehiculos']['labels']["vehiculo_km_inicial"] : "Kilometraje ";
