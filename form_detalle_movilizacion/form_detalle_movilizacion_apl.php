...
$km_adicionales = "SELECT movilizacion_cant_km_adicional, movilizacion_Recorrido_Vehiculo
FROM control_vehicular.movilizacion
WHERE Id_Movilizacion = ".$this->id_movilizacion_ ."";
 
      $nm_select = $km_adicionales; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_km_adicionales = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->rs_km_adicionales[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_km_adicionales = false;
          $this->rs_km_adicionales_erro = $this->Db->ErrorMsg();
      } 
;

if (isset($this->rs_km_adicionales[0][0]))     
{
   
}


$galones_usados = "SELECT vehiculos.Vehiculo_Km_Galon
FROM movilizacion, vehiculos
WHERE movilizacion.IdVehiculo = vehiculos.IdVehiculo
AND Id_Movilizacion = ".$this->id_movilizacion_ ."";
 
      $nm_select = $galones_usados; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_galones_usados = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->rs_galones_usados[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_galones_usados = false;
          $this->rs_galones_usados_erro = $this->Db->ErrorMsg();
      } 
;

if (isset($this->rs_galones_usados[0][0]))     
{
   
}

$total = $this->rs_distancia[0][0] + $this->rs_km_adicionales[0][0];

$total_galones_usados =round($total/$this->rs_galones_usados[0][0],2);

$total_excedente = $this->rs_km_adicionales[0][1]-$total;




$gasto_combustible = "SELECT Movilizacion_Costo_Galon
FROM control_vehicular.movilizacion
WHERE Id_Movilizacion = ".$this->id_movilizacion_ ."";
 
      $nm_select = $gasto_combustible; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_gasto_combustible = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->rs_gasto_combustible[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_gasto_combustible = false;
          $this->rs_gasto_combustible_erro = $this->Db->ErrorMsg();
      } 
;
...
$total_gasto_combustible =round( $total_galones_usados*$this->rs_gasto_combustible[0][0],2);



$update_sql = "UPDATE movilizacion set Movilizacion_Total_Km_Recorrido = ".$total.", Movilizacion_Total_Galones = ".$total_galones_usados.", movilizacion_Excedente = ".$total_excedente." , movilizacion_total_combustible = ".$total_gasto_combustible." where Id_Movilizacion = ".$this->id_movilizacion_ ."";
...
$total_1 = str_replace(".",",",$total);
$total_galones_usados_1 = str_replace(".",",",$total_galones_usados);
$total_excedente_1 = str_replace(".",",",$total_excedente);
$total_gasto_combustible_1 = str_replace(".",",",$total_gasto_combustible);

$this->sc_master_value ('Movilizacion_Total_Km_Recorrido', $total_1);
$this->sc_master_value ('Movilizacion_Total_Galones', $total_galones_usados_1); 
$this->sc_master_value ('movilizacion_Excedente', $total_excedente_1); 
$this->sc_master_value ('movilizacion_total_combustible', $total_gasto_combustible_1);
$_SESSION['scriptcase']['form_detalle_movilizacion']['contr_erro'] = 'off';
}
//
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
}
?>
