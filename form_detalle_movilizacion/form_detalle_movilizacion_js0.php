<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="iddetalle_movilizacion_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['iddetalle_movilizacion_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_detalle_movilizacion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_detalle_movilizacion_submit_form(y, z); 
} 
<?php
}
?>
