...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tipo_mantenimiento_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_mantenimiento']['labels']["tipo_mantenimiento_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipo_mantenimiento']['labels']["tipo_mantenimiento_estado"] : "Estado";
