...
<?php
   ...
   $Ord_Cmp = new grid_mantenimiento_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mantenimiento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idusuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idusuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idusuario"] : "Conductor";
   $tab_ger_campos['idvehiculo'] = "on";
   $tab_def_campos['idvehiculo'] = "IdVehiculo";
   $tab_converte["IdVehiculo"]   = "idvehiculo";
   $tab_labels["idvehiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idvehiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idvehiculo"] : "Descripcion del vehiculo";
   $tab_ger_campos['mantenimiento_fecha'] = "on";
   $tab_def_campos['mantenimiento_fecha'] = "mantenimiento_fecha";
   $tab_converte["mantenimiento_fecha"]   = "mantenimiento_fecha";
   $tab_labels["mantenimiento_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["mantenimiento_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["mantenimiento_fecha"] : "Fecha del Mantenimiento ";
   $tab_ger_campos['mantenimiento_kilometraje'] = "on";
   $tab_def_campos['mantenimiento_kilometraje'] = "mantenimiento_kilometraje";
   $tab_converte["mantenimiento_kilometraje"]   = "mantenimiento_kilometraje";
   $tab_labels["mantenimiento_kilometraje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["mantenimiento_kilometraje"])) ? $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["mantenimiento_kilometraje"] : "Kilometraje";
   $tab_ger_campos['idtipo_mantenimiento'] = "on";
   $tab_def_campos['idtipo_mantenimiento'] = "idTipo_Mantenimiento";
   $tab_converte["idTipo_Mantenimiento"]   = "idtipo_mantenimiento";
   $tab_labels["idtipo_mantenimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idtipo_mantenimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['labels']["idtipo_mantenimiento"] : "Tipo del Mantenimiento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE>Reporte de Mantenimiento Vehicular</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mantenimiento_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_mantenimiento']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
