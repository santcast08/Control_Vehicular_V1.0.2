...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_mantenimiento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Control_Vehicular_____grid_mantenimiento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mantenimiento'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mantenimiento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mantenimiento']['embutida_filho'] as $ind => $sc_init)
          {
