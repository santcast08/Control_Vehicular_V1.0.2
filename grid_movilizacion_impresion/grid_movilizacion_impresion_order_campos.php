...
<?php
   ...
   $Ord_Cmp = new grid_movilizacion_impresion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_movilizacion_impresion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idusuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["idusuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["idusuario"] : "Conductor";
   ...
   $tab_labels["movilizacion_funcionario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_funcionario"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_funcionario"] : "Funcionario";
   ...
   $tab_labels["movilizacion_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_fecha"] : "Fecha de Movilización";
   $tab_ger_campos['movilizacion_km_salida'] = "on";
   $tab_def_campos['movilizacion_km_salida'] = "Movilizacion_Km_Salida";
   $tab_converte["Movilizacion_Km_Salida"]   = "movilizacion_km_salida";
   $tab_labels["movilizacion_km_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_km_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_km_salida"] : "Kilometraje de Salida";
   $tab_ger_campos['movilizacion_km_llegada'] = "on";
   $tab_def_campos['movilizacion_km_llegada'] = "Movilizacion_Km_Llegada";
   $tab_converte["Movilizacion_Km_Llegada"]   = "movilizacion_km_llegada";
   $tab_labels["movilizacion_km_llegada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_km_llegada"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_km_llegada"] : "Kilometraje de Llegada";
   $tab_ger_campos['movilizacion_recorrido_vehiculo'] = "on";
   $tab_def_campos['movilizacion_recorrido_vehiculo'] = "movilizacion_Recorrido_Vehiculo";
   $tab_converte["movilizacion_Recorrido_Vehiculo"]   = "movilizacion_recorrido_vehiculo";
   $tab_labels["movilizacion_recorrido_vehiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_recorrido_vehiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["movilizacion_recorrido_vehiculo"] : "Kilometraje Recorrido por Vehiculo";
   $tab_ger_campos['rutas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rutas'] = "rutas";
       $tab_converte["rutas"]   = "rutas";
   }
   else
   {
       $tab_def_campos['rutas'] = "";
       $tab_converte[""]   = "rutas";
   }
   $tab_labels["rutas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["rutas"])) ? $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['labels']["rutas"] : "Rutas Efectuadas";
   $tab_ger_campos['rutas'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_movilizacion_impresion_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_movilizacion_impresion']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
