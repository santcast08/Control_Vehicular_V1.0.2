...
class grid_movilizacion_impresion_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_label'];
          $this->New_Format    = true;
      }
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_movilizacion_impresion.xml";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_movilizacion_impresion>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_movilizacion_impresion";
   ...
   function NM_export_movilizacion_km_salida()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->movilizacion_km_salida))
         {
          ...
          {
              $SC_Label = "movilizacion_km_salida"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->movilizacion_km_salida) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->movilizacion_km_salida) . "\"";
         }
   }
   ...
   function NM_export_movilizacion_km_llegada()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->movilizacion_km_llegada))
         {
          ...
          {
              $SC_Label = "movilizacion_km_llegada"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->movilizacion_km_llegada) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->movilizacion_km_llegada) . "\"";
         }
   }
   ...
   function NM_export_movilizacion_recorrido_vehiculo()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->movilizacion_recorrido_vehiculo))
         {
          ...
          {
              $SC_Label = "movilizacion_recorrido_vehiculo"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->movilizacion_recorrido_vehiculo) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->movilizacion_recorrido_vehiculo) . "\"";
         }
   }
   //----- rutas
   function NM_export_rutas()
   {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_movilizacion_reporte']['embutida']  = true;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_movilizacion_reporte']['xml_label'] = $this->Xml_tag_label;
                  $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xml?@?";
                  $detailParameters = array();
                  $detailParameters[] = "id_movilizacion?#?" . str_replace("'", "@aspass@", $this->Orig_id_movilizacion);
                  ...
                  $this->clear_tag($SC_Label); 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_movilizacion_reporte']['embutida_tit'] = "rutas";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_movilizacion_reporte']['embutida_xml_format'] = $this->New_Format;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movilizacion_impresion']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
