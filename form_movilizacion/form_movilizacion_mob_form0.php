...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_libre_line" id="hidden_field_data_libre" style="<?php echo $sStyleHidden_libre; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_libre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_libre_label"><span id="id_label_libre"><?php echo $this->nm_new_label['libre']; ?></span></span><br><span id="id_read_on_libre css_libre_line" style="<?php echo $sStyleReadLab_libre; ?>"><?php echo $this->form_encode_input($this->libre); ?></span><span id="id_read_off_libre" style="<?php echo $sStyleReadInp_libre; ?>"><span id="id_ajax_label_libre"><?php echo $libre?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_recorrido_vehiculo_line" id="hidden_field_data_movilizacion_recorrido_vehiculo" style="<?php echo $sStyleHidden_movilizacion_recorrido_vehiculo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_recorrido_vehiculo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_recorrido_vehiculo_label"><span id="id_label_movilizacion_recorrido_vehiculo"><?php echo $this->nm_new_label['movilizacion_recorrido_vehiculo']; ?></span></span><br><input type="hidden" name="movilizacion_recorrido_vehiculo" value="<?php echo $this->form_encode_input($movilizacion_recorrido_vehiculo); ?>"><span id="id_ajax_label_movilizacion_recorrido_vehiculo"><?php echo nl2br($movilizacion_recorrido_vehiculo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_total_km_recorrido_line" id="hidden_field_data_movilizacion_total_km_recorrido" style="<?php echo $sStyleHidden_movilizacion_total_km_recorrido; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_total_km_recorrido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_total_km_recorrido_label"><span id="id_label_movilizacion_total_km_recorrido"><?php echo $this->nm_new_label['movilizacion_total_km_recorrido']; ?></span></span><br><input type="hidden" name="movilizacion_total_km_recorrido" value="<?php echo $this->form_encode_input($movilizacion_total_km_recorrido); ?>"><span id="id_ajax_label_movilizacion_total_km_recorrido"><?php echo nl2br($movilizacion_total_km_recorrido); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_movilizacion_costo_galon_line" id="hidden_field_data_movilizacion_costo_galon" style="<?php echo $sStyleHidden_movilizacion_costo_galon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_costo_galon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_movilizacion_costo_galon_label"><span id="id_label_movilizacion_costo_galon"><?php echo $this->nm_new_label['movilizacion_costo_galon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_costo_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_costo_galon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
