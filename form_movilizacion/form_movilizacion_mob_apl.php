    ...
    function ValidateField_movilizacion_costo_galon(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_costo_galon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['php_cmp_required']['movilizacion_costo_galon'] == "on") 
           { 
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['Lookup_idusuario'][] = '';
   ...
   function ajax_return_values_idvehiculo($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['idvehiculo'] = array(
              ...
              $this->NM_ajax_info['fldList']['idvehiculo']['lookupCons'] = form_movilizacion_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
