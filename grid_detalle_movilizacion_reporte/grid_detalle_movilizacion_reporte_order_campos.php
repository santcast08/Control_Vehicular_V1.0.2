...
<?php
   ...
   $Ord_Cmp = new grid_detalle_movilizacion_reporte_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalle_movilizacion_reporte_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['detalle_movilizacion_origen'] = "on";
   $tab_def_campos['detalle_movilizacion_origen'] = "detalle_movilizacion_origen";
   $tab_converte["detalle_movilizacion_origen"]   = "detalle_movilizacion_origen";
   $tab_labels["detalle_movilizacion_origen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_origen"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_origen"] : "Detalle Movilizacion Origen";
   $tab_ger_campos['detalle_movilizacion_destino'] = "on";
   $tab_def_campos['detalle_movilizacion_destino'] = "detalle_movilizacion_destino";
   $tab_converte["detalle_movilizacion_destino"]   = "detalle_movilizacion_destino";
   $tab_labels["detalle_movilizacion_destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_destino"] : "Detalle Movilizacion Destino";
   $tab_ger_campos['detalle_movilizacion_fecha_inicio'] = "on";
   $tab_def_campos['detalle_movilizacion_fecha_inicio'] = "detalle_movilizacion_fecha_inicio";
   $tab_converte["detalle_movilizacion_fecha_inicio"]   = "detalle_movilizacion_fecha_inicio";
   $tab_labels["detalle_movilizacion_fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_fecha_inicio"] : "Detalle Movilizacion Fecha Inicio";
   $tab_ger_campos['detalle_movilizacion_fecha_fin'] = "on";
   $tab_def_campos['detalle_movilizacion_fecha_fin'] = "detalle_movilizacion_fecha_fin";
   $tab_converte["detalle_movilizacion_fecha_fin"]   = "detalle_movilizacion_fecha_fin";
   $tab_labels["detalle_movilizacion_fecha_fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_fecha_fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['labels']["detalle_movilizacion_fecha_fin"] : "Detalle Movilizacion Fecha Fin";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> detalle_movilizacion</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalle_movilizacion_reporte_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_detalle_movilizacion_reporte']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
