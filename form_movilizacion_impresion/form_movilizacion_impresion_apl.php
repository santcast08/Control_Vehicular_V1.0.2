<?php
//
class form_movilizacion_impresion_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Movilizacion_id) && isset($this->movilizacion_id)) 
          {
              $this->Movilizacion_id = $this->movilizacion_id;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_movilizacion_impresion_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_movilizacion_impresion']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movilizacion_impresion']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movilizacion_impresion'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_impresion']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_impresion']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_movilizacion_impresion') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movilizacion_impresion']['label'] = "Reporte Hoja de Rutas y Control de Combustible y Kilometraje";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_movilizacion_impresion")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['sc_idioma_pdf']['es'] = array('titulo' => $this->Ini->Nm_lang['lang_pdff_titl'], 'tp_imp' => $this->Ini->Nm_lang['lang_pdff_type'], 'color' => $this->Ini->Nm_lang['lang_pdff_colr'], 'econm' => $this->Ini->Nm_lang['lang_pdff_bndw'], 'tp_pap' => $this->Ini->Nm_lang['lang_pdff_pper'], 'carta' => $this->Ini->Nm_lang['lang_pdff_letr'], 'oficio' => $this->Ini->Nm_lang['lang_pdff_legl'], 'customiz' => $this->Ini->Nm_lang['lang_pdff_cstm'], 'alt_papel' => $this->Ini->Nm_lang['lang_pdff_pper_hgth'], 'larg_papel' => $this->Ini->Nm_lang['lang_pdff_pper_wdth'], 'orient' => $this->Ini->Nm_lang['lang_pdff_pper_orie'], 'retrato' => $this->Ini->Nm_lang['lang_pdff_prtr'], 'paisag' => $this->Ini->Nm_lang['lang_pdff_lnds'], 'book' => $this->Ini->Nm_lang['lang_pdff_bkmk'], 'grafico' => $this->Ini->Nm_lang['lang_pdff_chrt'], 'largura' => $this->Ini->Nm_lang['lang_pdff_wdth'], 'fonte' => $this->Ini->Nm_lang['lang_pdff_font'], 'sim' => $this->Ini->Nm_lang['lang_pdff_chrt_yess'], 'nao' => $this->Ini->Nm_lang['lang_pdff_chrt_nooo'], 'group_general' => $this->Ini->Nm_lang['lang_pdff_group_general'], 'group_chart' => $this->Ini->Nm_lang['lang_pdff_group_chart'], 'password' => $this->Ini->Nm_lang['lang_app_xls_pswd'], 'cancela' => $this->Ini->Nm_lang['lang_pdff_cncl']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_view'] = true;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opc_ant'] == "novo")
          {
              $this->nmgp_opcao = "novo";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao'] = "novo";
          }
          else
          {
              $this->nmgp_opcao = "igual";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao'] = "igual";
          }
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $_SESSION['scriptcase']['error_icon']['form_movilizacion_impresion']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_movilizacion_impresion'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_orig'] = " where Id_Movilizacion = " . $_SESSION['Movilizacion_id'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_pesq'] = " where Id_Movilizacion = " . $_SESSION['Movilizacion_id'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movilizacion_impresion']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movilizacion_impresion'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movilizacion_impresion'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_movilizacion_impresion", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_movilizacion_impresion/form_movilizacion_impresion_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_movilizacion_impresion_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_movilizacion_impresion_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_movilizacion_impresion_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_movilizacion_impresion/form_movilizacion_impresion_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_movilizacion_impresion_erro.class.php"); 
      }
      $this->Erro      = new form_movilizacion_impresion_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao']))
         { 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_movilizacion_impresion']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['imprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['botoes']['imprimir'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['form_detalle_movilizacion_impresion_script_case_init'] ]['form_detalle_movilizacion_impresion']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_movilizacion_impresion') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_movilizacion_impresion') . "/form_detalle_movilizacion_impresion_apl.php");
          $this->form_detalle_movilizacion_impresion = new form_detalle_movilizacion_impresion_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_movilizacion_impresion_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_movilizacion_impresion_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['prt_view'])
          { 
              echo $str_htm ;
              exit;
          } 
          ...
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_movilizacion_impresion";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['pdf_name'] : "form_movilizacion_impresion";
...
<HEAD>
 <TITLE><?php echo strip_tags("Reporte Hoja de Rutas y Control de Combustible y Kilometraje") ?></TITLE>
...
<form name="Fdown" method="get" action="form_movilizacion_impresion_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_movilizacion_impresion"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_movilizacion_impresion']) || !is_array($this->NM_ajax_info['errList']['geral_form_movilizacion_impresion']))
              {
                  $this->NM_ajax_info['errList']['geral_form_movilizacion_impresion'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_movilizacion_impresion'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->idusuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['Lookup_idusuario']) && !in_array($this->idusuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['Lookup_idusuario']))
               {
    ...
    function ValidateField_movilizacion_funcionario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (!empty($this->movilizacion_funcionario))
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['Lookup_movilizacion_funcionario']) && !in_array($cada_cmp_SC, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['Lookup_movilizacion_funcionario']))
              {
                  $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_movilizacion']['keyVal'] = form_movilizacion_impresion_pack_protect_string($this->nmgp_dados_form['id_movilizacion']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] < 0)
              {
...
$aLookup[] = array(form_movilizacion_impresion_pack_protect_string('') => form_movilizacion_impresion_pack_protect_string('Seleccione'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['Lookup_idusuario'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_movilizacion_impresion_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_movilizacion_impresion_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idusuario']['valList'][$i] = form_movilizacion_impresion_pack_protect_string($v);
          }
   ...
   function ajax_return_values_idvehiculo($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['idvehiculo'] = array(
              ...
              $this->NM_ajax_info['fldList']['idvehiculo']['lookupCons'] = form_movilizacion_impresion_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
else
{
   ...
   function ajax_return_values_detalle_movilizacion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_movilizacion_impresion']['contr_erro'] = 'on';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_movilizacion_impresion' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_movilizacion_impresion']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = false; 
          $SC_ex_upd_or = false; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->detalle_movilizacion = $this->detalle_movilizacion_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_detalle_movilizacion_impresion->ini_controle();
              if ($this->form_detalle_movilizacion_impresion->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_movilizacion_impresion']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['parms'] = "id_movilizacion?#?$this->id_movilizacion?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_movilizacion_impresion = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] = $qt_geral_reg_form_movilizacion_impresion;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_movilizacion))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_movilizacion_impresion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] > $qt_geral_reg_form_movilizacion_impresion)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] = $qt_geral_reg_form_movilizacion_impresion; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_movilizacion_impresion) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] < $qt_geral_reg_form_movilizacion_impresion;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_movilizacion_impresion_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter_form'] . " and (Id_Movilizacion = " . $_SESSION['Movilizacion_id'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_movilizacion_impresion = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['total'] = $qt_geral_reg_form_movilizacion_impresion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_movilizacion_impresion_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_movilizacion_impresion_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_movilizacion_impresion_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_impresion']['masterValue']))
{
